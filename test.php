...
<div class="container">
    ...
    <div class="image-section">
        <img src="<?php echo esc_url('https://tse4.mm.bing.net/th/id/OIP.NLuP6Q7V5dg3eSdpLxUt2QHaE7?pid=Api&P=0&h=220'); ?>" alt="Login illustration">
    </div>
        ...
        <div class="form-box">
            ...
            <form id="loginForm" method="post">
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="login_password" id="login_password" placeholder="Mật khẩu" required>
                </div>
