  ...
  <div class="deposit-section">
    <div class="deposit-header">
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
        <path d="M20 10C14.48 10 10 14.48 10 20C10 25.52 14.48 30 20 30C25.52 30 30 25.52 30 20C30 14.48 25.52 10 20 10ZM20 22C18.9 22 18 21.1 18 20C18 18.9 18.9 18 20 18C21.1 18 22 18.9 22 20C22 21.1 21.1 22 20 22Z" fill="#0066ff" />
        <path d="M25 15L28 12M12 28L15 25M12 12L15 15M28 28L25 25" stroke="#0066ff" stroke-width="2" stroke-linecap="round" />
      </svg>
    ...
    <div class="deposit-notes">
      ...
      <p>- Sau khi nhập số tiền và nạp sẽ được chuyển sang trang thanh toán bằng mã QR và số tiền sẽ được chúng tôi xử lý ngay lập tức mọi thắc mắc liên hệ số 034.770.0437</p>
