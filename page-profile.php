...
/* Phần này mở rộng form full width */
.profile-form {
    background: white;
    padding: 30px;
    border-radius: 10px;
...
<body>
    ...
    <div class="profile-form">
        ...
        <div class="form-group">
            ...
            <div class="form-input-wrapper">
                <input type="email" class="form-input disabled" id="email" value="davidbeckham.tvd11@gmail.com" disabled>
                ...
                <div class="country-dropdown" id="country-dropdown">
                    ...
                    <div class="country-list">
                        ...
                        <div class="country-item" data-code="+66" data-flag="th">
                            <img src="https://flagcdn.com/w40/th.png" alt="Thailand">
    ...
    <script>
        ...
        document.querySelectorAll('.country-item').forEach(item => {
            item.addEventListener('click', function() {
                ...
                phoneInput.placeholder = codeWithoutPlus + 'xxxxxxxxx';
        ...
        document.getElementById('verify-otp')?.addEventListener('click', function() {
            ...
            if (otp.length === 6) {
                ...
                document.getElementById('email-otp-modal').classList.remove('show');
                alert('Xác thực thành công! Bạn có thể chỉnh sửa email.');
            } else {
