...
<div class="page-header">
    ...
    <p class="page-subtitle">Hãy nhanh tay trở thành membership của TRADE PROXY để nhận được những ưu đãi hấp dẫn</p>
</div>

<div class="ranks-intro">
    <div class="intro-header">
        <div class="intro-title">Thành viên TRADE PROXY</div>
        <div class="intro-subtitle">Khám phá các hạng thành viên và đặc quyền đi kèm</div>
    </div>
        ...
        <div class="discount-row">
            <div class="discount-left">
                ...
                <div class="discount-badge-wrapper">
                    <span class="discount-badge">Cần Level 2</span>
                </div>
            </div>
